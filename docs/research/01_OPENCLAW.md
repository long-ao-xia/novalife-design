...
- **Claude Computer Use** (2025): Anthropic 推出的让 AI 控制电脑的能力
- **AI Agent Architecture (2026)**: Redis 博客的全面架构指南
- **Building Persistent AI Agent Memory**: 4层文件基础的记忆架构

### 关键洞见

2025-2026 年的趋势:
1. **持久记忆**成为 Agent 架构的核心组件
2. **单上下文 Agent** 开始受到关注 (vs 多 Session)
3. **情感/激素系统** 重新被重视 (arXiv: Scaffolding AI Agents with Hormones and Emotions)
